...
class PhaseEstimator {
     ...
     */
    estimatePhase(tsSeries, basePeriodMs) {
     ...
     */
    detectPeriod(tsSeries) {
        if (tsSeries.length < 10)
            return 0;
        const intervals = [];
...
exports.PhaseEstimator = PhaseEstimator;
//# sourceMappingURL=phase_estimator.js.map